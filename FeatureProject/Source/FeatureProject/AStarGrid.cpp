...
void AAStarGrid::AddNeighbors(FAStarCell &a_cell)
{
  ...
  //left cell
  FAStarCell* c = GetCellByIndex(a_cell.gridIndex + FVector(-1, 0, 0));
  if (c && c->walkable)
...
void AAStarGrid::ExtendGrid(FVector a_newGridSize)
{
...
void AAStarGrid::ExtendGrid(FVector a_newGridSize, FVector a_newGridOffset)
{
  m_gridSize = a_newGridSize;
...
FAStarCell* AAStarGrid::GetCellByPosition(FVector a_position)
{
...
void AAStarGrid::DrawDebug()
{
  for (FAStarCell &cell : m_grid)
  {
